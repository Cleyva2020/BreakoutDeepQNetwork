...
#
# def stack_frames(stack_frames, frame, buffer_size):
...
#             stacked_frames[buffer_size-1,:] = stack_frames
#
...
#     agent = Agent(gamme=0.99, epsilon=1.0, alpha=0.00025, input_dims=(180,160,4), n_actions=3, mem_size=6000, batch_size=32)
#     if load_checkpoint:
#         agent.load_models()
#     filename = 'breakout-alpha0p00025-gamma0p99-only-one-fc.png'
#     scores = []
#     numGames = 200
#     stack_size = 4
#     score = 0
